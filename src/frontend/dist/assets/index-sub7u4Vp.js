...
function Header({ onLogoClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-primary text-primary-foreground shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        "data-ocid": "nav.link",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary-foreground/10 border-2 border-primary-foreground/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-5 h-5 text-primary-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-lg tracking-wide", children: "SIBM HYDERABAD" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs opacity-80 tracking-widest", children: "SYMBIOSIS INSTITUTE OF BUSINESS MANAGEMENT" })
          ] })
        ]
      }
    ),
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-gray-900 text-gray-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-6 h-6 text-red-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-white text-lg", children: "SIBM HYDERABAD" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed text-gray-400", children: "Symbiosis Institute of Business Management, Hyderabad — nurturing future business leaders since 2010." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold mb-4 text-sm tracking-wider uppercase", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: quickLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold mb-4 text-sm tracking-wider uppercase", children: "Admissions" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: admissionLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            className: "hover:text-red-400 transition-colors flex items-center gap-1",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold mb-4 text-sm tracking-wider uppercase", children: "Contact Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 mt-0.5 text-red-400 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Survey No. 292/293, Narsingi, Hyderabad – 500075" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-red-400 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+91-40-6730-0000" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 text-red-400 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "admissions@sibmhyd.edu.in" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-gray-700 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-gray-500", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "SIBM Hyderabad — Admissions 2026-28" })
    ] })
  ] }) });
}
function HomePage({ onSubmit }) {
  const [appNo, setAppNo] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, #1a0404 0%, #5a0e0e 50%, #8b1a1a 100%)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-8 right-16 w-72 h-72 rounded-full opacity-5 bg-white" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-16 right-24 w-48 h-48 rounded-full opacity-5 bg-white" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-300 text-sm font-semibold tracking-[0.25em] uppercase mb-3", children: "Admissions 2026–28" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight max-w-3xl", children: [
              "Check Your",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "Application Results"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-100/70 mt-4 text-lg max-w-xl", children: "MBA Programme · SIBM Hyderabad · Batch 2026–28" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 w-24 h-1 bg-red-400 rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-red-700 via-red-400 to-red-700" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl sm:text-3xl font-bold text-foreground mb-2", children: "Enter Application Details to Check Result" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Please enter your application number exactly as provided during registration." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 w-12 h-0.5 bg-primary mx-auto rounded-full" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "form",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center mt-4", children: "Results for MBA Admissions 2026–28 are now available online." })
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl sm:text-3xl font-bold text-foreground mb-2", children: "How to Check Your Results" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-0.5 bg-primary mx-auto rounded-full mt-3" })
      ] }),
      ...
      ].map(({ icon: Icon2, step, title, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "bg-white rounded-xl p-8 border border-border shadow-xs flex flex-col items-center text-center",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-7 h-7 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold tracking-widest text-primary mb-1", children: [
              "STEP ",
              step
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-lg mb-2", children: title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl sm:text-3xl font-bold text-foreground mb-2", children: "Admissions Timeline 2026–28" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-0.5 bg-primary mx-auto rounded-full mt-3" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
        {
      ...
      ].map(({ month, event, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 rounded-full bg-primary mt-1.5 shrink-0" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold tracking-widest text-primary uppercase", children: month }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-1 mb-1", children: event }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: desc })
        ] })
      ] }, month)) })
    ] }) })
...
function RejectionLetterPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 bg-secondary min-h-[60vh]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex items-center gap-2 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Application Result" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "article",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center border-b-2 border-primary pb-6 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "text-primary text-2xl font-bold tracking-widest mb-1",
                style: { fontFamily: "'Times New Roman', Times, serif" },
                children: "SIBM HYDERABAD"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-700 text-sm tracking-wide", children: "Symbiosis Institute of Business Management" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500 text-xs mt-0.5 tracking-widest uppercase", children: "Hyderabad Campus" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500 text-xs mt-1", children: "Survey No. 292/293, Narsingi, Hyderabad – 500075" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500 text-xs", children: "Tel: +91-40-6730-0000 | admissions@sibmhyd.edu.in" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm text-gray-600 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Application No.: " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: appNo })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "April 1, 2026" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-800 underline text-sm", children: "RE: MBA Admissions 2026–28 – Application Result" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-5 text-gray-800", children: [
            "Dear ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "ANSH ARYA" }),
            ","
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-gray-700 text-sm leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We thank you for your interest in the MBA Programme (Batch 2026–28) at the Symbiosis Institute of Business Management, Hyderabad and for taking the time to go through our rigorous selection process." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "After a comprehensive evaluation of your academic credentials, SNAP scores, performance in the Group Discussion, and the Personal Interview, we regret to inform you that",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "you have not been selected" }),
              " for admission to the MBA Programme 2026–28 at SIBM Hyderabad."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The selection process this year was highly competitive, with a large number of qualified applicants vying for a limited number of seats. This decision is not a reflection of your potential; rather, it reflects the extremely competitive nature of our admissions." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We sincerely appreciate the effort and dedication you demonstrated throughout the admissions process and encourage you to explore other opportunities to pursue your academic and professional goals." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We wish you every success in your future endeavours." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 text-gray-800 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Yours sincerely," }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 border-t border-gray-300 pt-4 w-40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold", children: "Admissions Committee" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "SIBM Hyderabad" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-10 text-xs text-gray-400 border-t border-gray-200 pt-4", children: "This is an official communication from SIBM Hyderabad. For queries, contact admissions@sibmhyd.edu.in." })
        ]
      }
    ),
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { onLogoClick: handleBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: page === "home" ? /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, { onSubmit: handleSubmit }) : /* @__PURE__ */ jsxRuntimeExports.jsx(RejectionLetterPage, { appNo, onBack: handleBack }) }),
